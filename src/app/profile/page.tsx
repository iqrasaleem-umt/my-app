  ...
  return (
    <section>
      ...
      <div className="flex items-center justify-center min-h-screen mt-8 px-4 sm:px-6 md:px-8">
        <div className="bg-white p-8 rounded-lg w-full max-w-md sm:max-w-lg md:max-w-xl shadow-lg">
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="relative w-24 h-24 bg-gray-300 rounded-full mt-4 mb-6"></div>
          </div>
